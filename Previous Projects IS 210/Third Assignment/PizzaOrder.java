...
public class PizzaOrder
{
   public static void main (String[] args)
   {
      ...
      {
         System.out.println("Incorrect Pizza Size. A pizza size of 12 inches will be made.");
         cost = 12.99;
      }
      ...
      switch(crustType)
   {
      ...
      case 'd':
        crust = "Deep-dish";
             break;
      default:
        System.out.println("Incorrect Crust Type. A Hand-tossed crust will be made.");
        crust = "Hand-tossed";
             break;
   }
